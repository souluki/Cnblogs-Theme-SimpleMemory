...
if (initCheck()) {
    ...
    window.cnblogsConfigDefault = {
        ...
        homeTopImg: [
            "https://cdn.jsdelivr.net/gh/souluki/Cnblogs-Theme-SimpleMemory@master/img/webp/home_top_bg.webp"
        ],
        homeBannerText: "",
...
function getVersionConfig() {
    ...
    } else if(window.cnblogsConfig.GhUserName === 'souluki') {
        window.themeVersion = [
            [
                "v1.1.6",
